...
const RULES: readonly AllowRule[] = [
  ...
  { methods: ["POST"], path: /^character-factory\/image-runs$/, capability: DAILY },
  { methods: ["GET"], path: /^character-factory\/image-runs\/[^/]+$/, capability: DAILY },
  { methods: ["POST"], path: /^character-factory\/image-runs\/[^/]+\/(?:prompt|generate|edits)$/, capability: DAILY },
  { methods: ["POST"], path: /^character-factory\/image-runs\/[^/]+\/prompt\/confirm$/, capability: DAILY },
  { methods: ["POST"], path: /^character-factory\/image-runs\/[^/]+\/candidates\/[^/]+\/select$/, capability: DAILY },
  { methods: ["POST"], path: /^character-factory\/image-runs\/[^/]+\/versions\/[^/]+\/finalize$/, capability: DAILY },
  { methods: ["POST"], path: /^character-factory\/image-runs\/[^/]+\/tasks\/[^/]+\/retry$/, capability: DAILY },
  { methods: ["GET"], path: /^character-factory\/image-runs\/[^/]+\/media\/[^/]+$/, capability: DAILY },
